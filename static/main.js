document.addEventListener("DOMContentLoaded", function () {
  ...
  if (document.body.id === "index-body") {
    ...
    const driverLoadingSpinner = document.getElementById(
  ...
  if (document.body.id === "result-body") {
    ...
    function initializeChatWithContext() {
      ...
      const driverTimeElements = document.querySelectorAll(
        ".driver-time .lap-time"
      );
      ...
      window.currentRaceContext = {
        raceTitle,
        driverTimes,
        plotVisible: document.querySelector(".plot-container img")
          ? true
          : false,
      };
