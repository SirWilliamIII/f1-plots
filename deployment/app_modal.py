...
# Separate volumes for data and models for better organization
...
image = (
    ...
    # Add all application source files to the image (entire project root, not just deployment/)
...
@app.function(
    ...
    timeout=600,  # 10 minute timeout for plot generation (increased from 5 minutes)
    min_containers=1,  # Keep 1 container warm to reduce cold starts
)
...
def web():
    ...
    os.environ["DISABLE_PRELOADING"] = "true"  # Disable session preloading on Modal
    ...
    # Import and create Flask app using factory pattern
